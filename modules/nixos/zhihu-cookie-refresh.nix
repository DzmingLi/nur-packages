  ...
  refreshScript = pkgs.writeText "zhihu-cookie-refresh.js" ''
    ...
    (async () => {
      ...
      try {
        ...
        // Wait for __zse_ck (generated by WASM in zse-ck/v3.js)
        let zseCk = null;
        try {
        ...
        if (!zseCk) {
          // Also try reading __g.ck from the page global (v3.js sets this)
          try {
        ...
        if (zseCk) {
          console.log('Got __zse_ck:', zseCk.substring(0, 20) + '...');
        } else {
